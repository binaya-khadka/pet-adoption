    ...
    <Layout>
      <div>
        {fetchedUser && currentUser?.id ? (
            ...
            <FormContainer>
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  ...
                  value={isLoading ? 'Adding' : 'Add Pet'}
                />
              </Form>
            </FormContainer>
          </>
          ...
          <>
            <div
              style={{ maxWidth: 1200, margin: '0 auto', paddingTop: '50px' }}
            >
              <div
                style={{
                  maxWidth: 1000,
              ...
              >
                <h1
                  style={{
                    background: 'linear-gradient(20deg, orange, blue)',
                    color: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text'
                  }}
                >
                  Sorry you cannot add any pet when you are logged out. Please
                  Login or Register to add pets.
                </h1>
              </div>
